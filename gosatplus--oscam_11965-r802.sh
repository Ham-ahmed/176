...
echo -e "${CYAN}"
echo "################################################################"
echo "# Start downloading and installing gosatplus--oscam_11965-r802 #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/176/refs/heads/main/enigma2-plugin-softcams-gosatplus-oscam_11965-emu-r802_all.ipk"
IPK_NAME="enigma2-plugin-softcams-gosatplus-oscam_11965-emu-r802_all.ipk"
