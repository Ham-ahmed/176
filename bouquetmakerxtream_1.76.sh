...
echo -e "${CYAN}"
echo "################################################################"
echo "#  Start downloading and installing  bouquetmakerxtream_1.76   #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/176/refs/heads/main/enigma2-plugin-extensions-bouquetmakerxtream_1.76.20260510_all.ipk"
IPK_NAME="enigma2-plugin-extensions-bouquetmakerxtream_1.76.20260510_all.ipk"
